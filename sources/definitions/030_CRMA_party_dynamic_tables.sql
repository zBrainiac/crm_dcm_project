-- ============================================================
-- 030 — CRMA Party Dynamic Tables (Curated Layer)
-- DCM Project: CRM Domain
-- ============================================================
--
-- OVERVIEW:
-- Curated-layer dynamic tables providing current-state and
...
--
-- REFRESH:
-- Both tables use TARGET_LAG = 1 hour for near-real-time
-- propagation from the RAW layer.
-- ============================================================

DEFINE DYNAMIC TABLE {{ sf_db }}.{{ SCHEMA_CRM_CUR }}.CRMA_CUR_DT_PARTY
  TARGET_LAG = '1 hour'
  WAREHOUSE = {{ wh }}
...
DEFINE DYNAMIC TABLE {{ sf_db }}.{{ SCHEMA_CRM_CUR }}.CRMA_CUR_DT_PARTY_HIST
  TARGET_LAG = '1 hour'
  WAREHOUSE = {{ wh }}
